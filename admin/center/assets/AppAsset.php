...
class AppAsset extends AssetBundle
{
    ...
    public function init()
    {
        $this->js = [
            ...
            'lib/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js', //日期时间控件
            'lib/bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.'.\Yii::$app->language.'.js', //日期时间语言控件
            'js/main.js',/* 基础配置库 */
            'sources/toastr/toastr.js', /* 漂亮的弹出层 DM */
            'lib/layer-master/layer.js'
        ];
        parent::init();
    }
}
