 ...
 */
class OnlineReportProducts extends  BaseModel
{
    public $base = 'products_id';
    /**
     * @inheritdoc
     */
    public static function tableName()
    {
        return 'online_report_products';
    }
    ...
    {
        return [
            //[['time_point', 'products_id', 'count', 'bytes_in', 'bytes_out', 'time_long'], 'required'],
            [['start_At', 'stop_At'], 'required'],
            [['start_At', 'stop_At', 'unit', 'type'], 'string'],
            ['step', 'integer', 'min' => 1],
            [['time_point', 'products_id', 'count', 'bytes_in', 'bytes_out', 'time_long'], 'integer']
        ];
    }
