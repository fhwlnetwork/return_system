...
<div class="panel panel-default">
	<div class="panel-body">
		<div style="height:40px;line-height:40px"><font class="collect_report_title"><?= Yii::t('app', 'online terminaltype chart') ?></font> <span style="color:#333;font-size:12px;"></span></div>		
...
<script type="text/javascript">
    ...
    require(
        ...
        function (ec) {
			...
			var myChart = ec.init(document.getElementById('terminal')	,{
				  noDataLoadingOption:{
