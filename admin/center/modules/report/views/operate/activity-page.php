...
$this->title = Yii::t('app', 'report/operate/activity');
    ...
    <div class="panel-body" style="padding: 10px">
        ...
        <div class="col-md-2" style="width:270px;">
            <div class="input-group" style="border:1px solid #cbd5dd">
                <?= Html::dropDownList('SrunDetailDay[step]', isset($model->step) ? $model->step : '20', SrunDetailDay::getAttributesList()['step'], ['class' => 'form-control', 'style' => 'border:0px;height:32px;']); ?>
        ...
        <?php else: ?>
            <div class="panel panel-default">
                <?= $this->render('/map/times', [
                    'data' => $source['data'],
                    'model' => $model,
                    'name' => Yii::t('app', 'report/operate/activity')
                ]) ?>
            </div>
            <table class="table table-bordered table-striped table-responsive table-hover">
                ...
                <tr>
                    <th nowrap="nowrap">
                        <div class="th"><?= Yii::t('app', 'Active section') ?></div>
                    </th>
                    <th nowrap="nowrap">
