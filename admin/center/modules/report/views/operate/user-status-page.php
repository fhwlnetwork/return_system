...
$this->title = Yii::t('app', 'report/operate/userstatus');

if (Yii::$app->session->get('status_usergroup')) {
    $searchField = array_keys(Yii::$app->session->get('status_usergroup'));
} else {
    $searchField = [];
}
?>
    ...
    require(
        ...
        function (ec) {
            ...
            var option = {
                ...
                series: [
                    {
                        name: "<?= Yii::t('app', 'report operate remind2') ?>",
                        type: 'pie',
                        radius: ['60%', '80%'],
						center: ['50%', '55%'],
                        itemStyle: {
