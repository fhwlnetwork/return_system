...
<div class="panel panel-default">
    <div class="panel-body" style="padding: 10px">
        ...
        <div class="col-md-12 form-group" ng-cloak ng-show="advanced==1">
            <div class="col-md-2"><?= Yii::t('app', 'report online bilingfont') ?>.</div>
            <div class="col-md-10">
                <?= Html::checkboxList('OnlineReportBilling[showField][]', $searchField, $showField, ['class' => 'drag_inline']) ?>
            </div>
        </div>
        ...
        <?php if (!empty($source['table'])) : ?>
            <?php if ($model->flag): ?>
                <?= $this->render('/map/report', [
                    'data' => $source['data'],
                    'model' => $model,
                    'title' => Yii::t('app', 'operate type Strategy Billing') . ':' .$showField[$searchField[0]],
            ...
            <?php else: ?>
                <?= $this->render('/map/products', [
                    'data' => $source['data'],
                    'model' => $model,
                    'title' => Yii::t('app', 'operate type Strategy Billing'),
                    'type' => $attributes[$model->sql_type]. Yii::t('app', 'monitor'),
