...
ReportAsset::accountantJs($this);


$this->title = Yii::t('app', 'report/accountant/index');
...
<div class="page page-dashboard">
        ...
        <div class="col-lg-3 col-xsm-6">
            <div class="panel mini-box">
                ...
                <div class="box-info">
                    ...
                    <p class="text-muted"><?= Yii::t('app', 'Payment this month') ?></p>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-xsm-6">
            <div class="panel mini-box">
                ...
                <div class="box-info">
                    ...
                    <p class="text-muted"><?= Yii::t('app', 'Last month payment') ?></p>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-xsm-6">
            <div class="panel mini-box">
                ...
                <div class="box-info">
                    ...
                    <p class="text-muted"><?= Yii::t('app', 'Last last month payment') ?></p>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-xsm-6">
            <div class="panel mini-box">
                ...
                <div class="box-info">
                    ...
                    <p class="text-muted"><?= Yii::t('app', 'Total payment') ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class='raw' style='margin-top: 30px;margin-bottom: 30px;'>
        <!--   最近用户组消费top40-->
        <div class="col-md-6" style="padding-right: 15px;background: #f1f1f1;">
            <div id="recently-thirty-type" class="col-md-12" style="height:500px;padding:30px"></div>
        </div>
        <!--    最近产品消费-->
        <div class="col-md-6" style="padding-left: 15px;background: #f1f1f1;">
            <div id="recently-sixty-type" class="col-md-12" style="height:500px;padding:30px"></div>
        </div>
    </div>
