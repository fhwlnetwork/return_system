...
$this->title = \Yii::t('app', 'batch edit');
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul class="nav nav-tabs">
                    ...
                    <li if($canEdit):?><li <?php if ($action == 'import'): ?>class="active"<?php endif ?>>
                    ...
                    <li <?php if ($action == 'batch-edit'): ?>class="active"<?php endif ?>>
                        <?= Html::a(Yii::t('app', 'batch edit'), ['import']) ?>
                    </li>
                </ul>
                <div class="tab-content">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-2" for="savingcard-passwd_len"><?= Yii::t('app','batch excel select')?></label>
                                            <div class="col-sm-6">
                                                <?= Html::checkboxList('selectFields[]', $model->conditionField, $model->editFields, ['class'=>'drag_inline']) ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-8 col-sm-offset-3">
                                        <?= Html::submitInput(Yii::t('app', 'preview'), ['name' => 'preview', 'class' => 'btn btn-success', 'style'=>'margin-left:-100px;margin-top:10px;width:80px;']) ?>
                                    </div>
                    ...
                    <div class="callout callout-info">
                        ...
                        <p><?= Yii::t('app', 'user available') .':'. Yii::t('app', 'batch edit help7');?></p>
                    </div>
