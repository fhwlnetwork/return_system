...
$this->title = \Yii::t('app', 'user/complaints/index');



$canAdd = Yii::$app->user->can('user/complaints/add');
$canList = Yii::$app->user->can('user/complaints/index');
$canView = Yii::$app->user->can('user/complaints/view');
        ...
        <div class="panel panel-default">
            ...
            <?php if (!empty($list)) : ?>
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        <th>#</th>
                        <th><?= Yii::t('app', 'bug type') ?></th>
                        <th><?= Yii::t('app', 'bug title') ?></th>
                        <th><?= Yii::t('app', 'bug content') ?></th>
                        <th><?= Yii::t('app', 'bug publish time') ?></th>
                        <th><?= Yii::t('app', 'bug target') ?></th>
                        <th><?= Yii::t('app', 'hope process time') ?></th>
                        <th><?= Yii::t('app', 'bug state') ?></th>
                        <th><?= Yii::t('app', 'bug solution time') ?></th>
