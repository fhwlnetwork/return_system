...
$this->title = \Yii::t('app', 'user/complaints/index-all');
                        ...
                        <table class="table table-bordered table-striped table-responsive table-hover">
                            ...
                            <tr style="height: 30px; line-height: 30px;align-content: center;">
                                ...
                                if( isset($params['showField']) && $params['showField'] ){
                                    //不需要排序的字段
                                    $no_sort_field = ['bug_title', 'bug_type', 'bug_target', 'products_key', 'bug_state'];
                                    ...
                                    foreach( $params['showField'] as $value ){
                                        if(in_array($value, $no_sort_field)){
                                            ...
                                            array_unshift($newParams, '/user/complaints/index-all');
