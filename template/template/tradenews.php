...
//
$pageSize=6;        //每页显示的记录数
$sql="select * from news where type =3;";
$_mySQLi = $dao;
...
$sql="select * from news where type =3 limit {$offset},{$pageSize}";
...
<div class="container">
		<div class="row">
		<div class="section-title"><h3 class="center">行业新闻</h3></div>
			<div class="col-md-9">
				<!-- Blog-Box -->
                <?php
                $sql = "select * from news where type=3 ORDER BY ctime ";
				...
				<section>
                    <div class="post-box fadeInUp animated">
							...
							<div class="col-sm-9 post-item">
								<h3><a href="./template/newspage.php?r=<?php echo $list3['id'];?>" target="_blank" rel="bookmark" title="带弹幕特效的清新博客主题bulletin免费发布" ><?php echo $list3['title'];?></a></h3>
