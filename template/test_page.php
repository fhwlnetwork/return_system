...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-9">
                ...
                <section>
                    <div class="post-box fadeInUp animated">
                        <div class="col-sm-3 post-img">
                            <img itemprop="image" class="media-object" src="<?php echo $list3['pic'];?>" />
                        </div>
                        <div class="col-sm-9 post-item">
                            <h3><a href="#gsh/323.html" target="_blank" rel="bookmark" title="带弹幕特效的清新博客主题bulletin免费发布" ><?php echo $list3['title'];?></a></h3>
            ...
            <?php endforeach;?>
            <?php echo showPage($page,$totalPage);  //输出页码链接?>
        </div>
